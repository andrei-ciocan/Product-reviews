...
<body ng-controller="ReviewController as vm">
	<div class="page-width">
		<page-limit limit="first.entryLimit" change="first.gotoFirstPage" ></page-limit>
	...
	<script type="text/javascript" src="Scripts/message.service.js"></script>
	...
	<script type="text/javascript" src="Scripts/Reviews/star-rating.js"></script>
	...
	<script type="text/javascript" src="Scripts/Reviews/page-limit.js"></script>
